...
const TaskDescription: React.FC<Props> = ({ task }) => {
    const { title, category, description, score, incoming_example, outgoing_example, tags } = task || {};
    ...
    <Descriptions title="Информация о задаче" bordered>
      ...
      <Descriptions.Item label="Входящие данные">{incoming_example}</Descriptions.Item>
      <Descriptions.Item label="Теги"><Tags tags={tags} /></Descriptions.Item>
      <Descriptions.Item label="Сложность">{score}</Descriptions.Item>
      <Descriptions.Item label="Исходящие данные">{outgoing_example}</Descriptions.Item>
