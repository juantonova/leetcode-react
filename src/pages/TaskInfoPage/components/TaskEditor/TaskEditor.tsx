...
import { CategoryType, CategoryTypeOptions, Score, ScoreOptions, Task } from "../../../../models/tasks";
...
const TaskEditor: React.FC<Props> = ({ task }) => {
    ...
    const { title, category, description, score, incoming_example, outgoing_example } = task || {};
    ...
    return (
      ...
      wrapperCol={{ span: 16 }}
      style={{ maxWidth: 600 }}
      initialValues={{ description, title, category, incoming_example, outgoing_example, score }}
      onFinish={onFinish}
